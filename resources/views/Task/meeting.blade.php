            ...
            <div class="col-8 offset-2 mt-5">
                <div class="card">
                    <div class="card-header bg-info">
                        <h3 class="text-white"> ADD MEETING </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('taskm.store') }}">
                        <div class="row">
                            <div class="col-md-6" style="border-right: 1px soild red;">
  <div class="form-group">
                                        {{ csrf_field() }}
                                        <label><strong>Title:</strong></label>
                                        <input type="text" name="title" class="form-control" placeholder="Enter title of meeting" value="{{ old('title') }}">
                                        @if ($errors->has('title'))
                                    ...
                                    <div class="form-group">
                                        <label for="time_zone"><strong>Time Zone:</strong></label>
                                        <!-- START TIME ZONE SNIPPET -->
                                            <!-- <label for="time_zone">Time Zone</label> -->
                                            <select id="time_zone" name="timeZone" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location" class="form-control" placeholder="Enter location of meeting" value="{{ old('location') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="description" rows="3" class="form-control" placeholder="Start typing the details about the meeting..." value="{{ old('description') }}"></textarea>
                                        @if ($errors->has('description'))
                                            <span class="text-danger">{{ $errors->first('description') }}</span>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        <label><strong>Add outcome:</strong></label>
                                        <input type="text" name="outCome" class="form-control"  value="{{ old('outCome') }}">
                                        @if ($errors->has('outCome'))
                                            <span class="text-danger">{{ $errors->first('outCome') }}</span>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        <label><strong>Add meeting notes:</strong></label>
                                        <input type="text" name="meetingNotes" class="form-control" value="{{ old('meetingNotes') }}">
                                        @if ($errors->has('meetingNotes'))
                                            <span class="text-danger">{{ $errors->first('meetingNotes') }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="attendees" class="form-control" placeholder="attendees" value="{{ old('attendees') }}">
                                        @if ($errors->has('attendees'))
                                            <span class="text-danger">{{ $errors->first('attendees') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
